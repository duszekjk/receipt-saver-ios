...
extension APIClient {
    func latestBankImportStatus() async throws -> BankImportJobStatus {
        var request = URLRequest(url: baseURL.appendingPathComponent("bank/import/status/latest/"), cachePolicy: .reloadIgnoringLocalCacheData)
